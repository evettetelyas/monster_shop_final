...
evette_addy = evette.addresses.create(name: 'Evette McEvette', address: '123 A Ave', city: 'Los Angeles', state: 'CA', zip: 90210)
order_1 = evette.orders.create(name: "Evette McEvette", street_address: "123 Evette Street", city: "Denver", state: "CO", zip: "12345", address: evette_addy)
...
tylor_addy = tylor.addresses.create(name: 'Tylor McTylor', address: '123 A Ave', city: 'Los Angeles', state: 'CA', zip: 90210)
order_2 = evette.orders.create(name: "Evette McEvette", street_address: "123 Evette Street", city: "Denver", state: "CO", zip: "12345", address: evette_addy)
...
fenton_addy = fenton.addresses.create(name: 'Fenton McFenton', address: '123 A Ave', city: 'Los Angeles', state: 'CA', zip: 90210)
order_3 = fenton.orders.create(name: "Fenton McFenton", street_address: "123 Fenton Street", city: "Denver", state: "CO", zip: "12345", address: fenton_addy)
...
order_4 = tylor.orders.create(name: "Tylor McTylor", street_address: "123 Tylor Street", city: "Denver", state: "CO", zip: "12345", address: tylor_addy)
